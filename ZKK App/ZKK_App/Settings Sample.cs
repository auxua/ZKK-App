...
namespace ZKK_App
{
    class Settings
    {
         ...
         *      
         * ak-zapf.txt, ak-kif.txt, ak-koma.txt, ak-common.txt
         ...
         * 
         * aklist-zapf.txt, aklist-kif.txt, aklist-koma.txt
        ...
        /// </summary>
        public static readonly string[] ContentFiles = { "ak-common", "ak-zapf", "ak-kif", "ak-koma", "aklist-kif", "aklist-koma", "aklist-zapf", "rooms", "roomfinder" };
